...
func main() {
	...
	url := ginSwagger.URL("http://" + config.SERVER + "/swagger/doc.json") // The url pointing to API definition
	router.GET("/swagger/*any", ginSwagger.WrapHandler(swaggerfiles.Handler, url))
	router.Run(config.SERVER) // listen and serve on 0.0.0.0:8080 (for windows "localhost:8080")
}
